...
public class UserServiceHelper {
	...
	public static Response addUserData() {
		...
		try {
			FileWriter file = new FileWriter("./createdUserData.txt");
	...
	public static void deleteUserData() {
		...
		Path path = Paths.get("./createdUserData.txt");

		try {
			String idToBeDeleted = Files.readString(path);
			System.out.println("The idToBeDeleted from file is" + idToBeDeleted);
